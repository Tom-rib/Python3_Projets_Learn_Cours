...
for i in range(5):
    ...
    if i < 4:
        resultat_48 += ","
check(48, resultat_48, "0,1,2,3,4")
...
for i in range(len(mot) // 2):
    if mot[i] != mot[len(mot) - 1 - i]:
        ...
        break
check(49, est_palindrome_49, True)
...
for i in range(len(mot) // 2):
    if mot[i] != mot[len(mot) - 1 - i]:
        ...
        break
check(50, est_palindrome_50, False)
